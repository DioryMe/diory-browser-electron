...
const getData = (diorys) => Object.entries(diorys).reduce((obj, [key, diory]) => {
...
const getLinks = (diorys) => Object.entries(diorys).reduce((obj, [key, { id }]) => ({
    ...obj,
    [key]: { id }
  }), {})

const getDiorys = (diorys) => Object.values(diorys).reduce((obj, diory) => ({
  ...obj,
  [diory.id]: diory
}), {})
